              ...
              <div className="p-4">
                <div className="grid grid-cols-2 gap-4 mb-4">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <p className="text-sm font-semibold">{program.training_frequency} días/semana</p>
                  </div>
                  
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <p className="text-xs text-gray-500">Duración</p>
                    <p className="text-sm font-semibold">{program.training_duration} meses</p>
                  </div>
                </div>
                ...
                <div className="flex justify-between text-sm">
                  <div>
                    ...
                    <span className="ml-1 font-semibold">{program.completed_sessions}/{program.total_sessions}</span>
                  </div>
